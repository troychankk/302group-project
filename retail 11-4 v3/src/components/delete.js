...
export default class Delete extends Component {
    ...
    componentDidMount(){
      ...
      getOrders = _ =>{
        ...
        fetch(`http://localhost:4000/orders/delete?o_id=${order.o_id}`)
        fetch(`http://localhost:4000/logistic/orders/delete?o_id=${order.o_id}`)
        .then(this.getOrders)
        .catch(err => console.error(err))
      }
              ...
              <div className="col-md-4">
                <div className="card">
                  <div className="card-body">
                    ...
                    <button type="button" className="btn btn-secondary" onClick={this.DelOrder}>Delete</button>
                  </div>
                </div><br />
              </div>
