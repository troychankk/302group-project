...
export default class Search extends Component {
    ...
    state = {
      ...
      addOrder =_ =>{
        ...
        fetch(`http://localhost:4000/logistic/orders/add?o_id=${order.o_id}&c_id=${order.c_id}&locker_location=${order.locker_location}&locker_number=${order.locker_number}&locker_password=${order.locker_password}`)
        .then(this.getOrders)
        .catch(err => console.error(err))
      }
